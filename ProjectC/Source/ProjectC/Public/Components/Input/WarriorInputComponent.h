 ...
 */
UCLASS()
class PROJECTC_API UWarriorInputComponent : public UEnhancedInputComponent
{
	GENERATED_BODY()
...
{
	checkf(InInputConfig, TEXT("Input config data asset is null, can not proceed with binding")); // 버그체크
